...
class _PayoutSettingsScreenState extends ConsumerState<PayoutSettingsScreen> {
  ...
  Future<void> _fetchBanks() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _banksError = e.response?.data?['message'] as String? ??
      ...
      if (mounted)
        setState(() {
          _banksError = 'Unexpected error loading banks.';
          _banksLoading = false;
        });
    }
  }
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  'Connect your bank account to receive your consultation payouts.',
                                  style: TextStyle(
                                ...
                                children: [
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () => _launchURL(
                                          "https://mdqplus.com/legal.html#payout-terms"),
                                  )
                                ],
                              )),
                            ]),
                      ...
                      Row(
                          ...
                          children: [
                            ...
                            Text(
                                ...
                                style:
                                    TextStyle(fontSize: 11, color: subtleText)),
                          ]),
                    ],
                  ),
                ),
  ...
  Widget _stateContainer(Color color,
      {required Widget child, List<BoxShadow>? shadow}) {
    return Container(
...
class _LinkedAccountView extends StatelessWidget {
  ...
  const _LinkedAccountView(
      {required this.doctor, required this.onChangePressed});
        ...
        children: [
                  ...
                  child: Column(
                    ...
                    Text('Account Linked',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold)),
                    SizedBox(height: 4),
                    Text('Your payouts are set up and ready.',
          ...
          Text('Linked Account',
              style: theme.textTheme.bodyMedium
                  ?.copyWith(fontWeight: FontWeight.w600, color: subtleText)),
          const SizedBox(height: 10),
...
class _BankPickerSheetState extends State<_BankPickerSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final cardColor =
        isDark ? const Color(0xFF1E2A3A) : const Color(0xFFF5F7FA);
    const accent = Color(0xFF4A90E2);
    final subtleText = isDark ? Colors.white54 : Colors.grey[600];
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _searchController.text.isNotEmpty
                    ? IconButton(
                        icon: Icon(Icons.clear, color: subtleText, size: 18),
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return ListTile(
                        leading: CircleAvatar(
                          radius: 18,
                          backgroundColor:
                              accent.withOpacity(isSelected ? 1.0 : 0.1),
